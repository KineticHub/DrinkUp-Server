...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Venue.contact_number'
        db.alter_column('MainApp_venue', 'contact_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Venue.venue_owner'
        db.alter_column('MainApp_venue', 'venue_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'AppUser.birthdate'
        db.alter_column('MainApp_appuser', 'birthdate', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Venue.contact_number'
        raise RuntimeError("Cannot reverse this migration. 'Venue.contact_number' and its values cannot be restored.")

        # Changing field 'Venue.venue_owner'
        db.alter_column('MainApp_venue', 'venue_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['MainApp.VenueOwnerUserProfile']))

        # User chose to not deal with backwards NULL issues for 'AppUser.birthdate'
        raise RuntimeError("Cannot reverse this migration. 'AppUser.birthdate' and its values cannot be restored.")
    ...
    models = {
        ...
        'MainApp.venueowneruserprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone_number': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
