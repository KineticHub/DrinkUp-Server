...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacebookAppUser.oauth_token'
        db.alter_column('MainApp_facebookappuser', 'oauth_token_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['MainApp.OAuthToken'], unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FacebookAppUser.oauth_token'
        raise RuntimeError("Cannot reverse this migration. 'FacebookAppUser.oauth_token' and its values cannot be restored.")
