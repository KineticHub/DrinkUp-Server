...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VenueBar.happyhour_start'
        db.alter_column('MainApp_venuebar', 'happyhour_start', self.gf('django.db.models.fields.TimeField')())

        # Changing field 'VenueBar.happyhour_end'
        db.alter_column('MainApp_venuebar', 'happyhour_end', self.gf('django.db.models.fields.TimeField')())

    def backwards(self, orm):

        # Changing field 'VenueBar.happyhour_start'
        db.alter_column('MainApp_venuebar', 'happyhour_start', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'VenueBar.happyhour_end'
        db.alter_column('MainApp_venuebar', 'happyhour_end', self.gf('django.db.models.fields.DateTimeField')())
