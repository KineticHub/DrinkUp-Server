...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.current_status'
        db.add_column('MainApp_order', 'current_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.current_status'
        db.delete_column('MainApp_order', 'current_status')
