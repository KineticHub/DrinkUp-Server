...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VenueOwnerUserProfile.phone_number'
        db.alter_column('MainApp_venueowneruserprofile', 'phone_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VenueOwnerUserProfile.phone_number'
        raise RuntimeError("Cannot reverse this migration. 'VenueOwnerUserProfile.phone_number' and its values cannot be restored.")
