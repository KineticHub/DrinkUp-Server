...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VenueOwnerUserProfile'
        db.create_table('MainApp_venueowneruserprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('phone_number', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True)),
        ))
        db.send_create_signal('MainApp', ['VenueOwnerUserProfile'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'VenueOwnerUserProfile'
        db.delete_table('MainApp_venueowneruserprofile')


        # Changing field 'Venue.venue_owner'
        db.alter_column('MainApp_venue', 'venue_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['MainApp.VenueOwner']))
    ...
    models = {
        ...
        'MainApp.venue': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'venue_owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['MainApp.VenueOwnerUserProfile']"})
        },
        'MainApp.venuebar': {
