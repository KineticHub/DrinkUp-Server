...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('MainApp_venue', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Venue.longitude'
        db.add_column('MainApp_venue', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('MainApp_venue', 'latitude')

        # Deleting field 'Venue.longitude'
        db.delete_column('MainApp_venue', 'longitude')
