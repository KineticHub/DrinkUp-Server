...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DrinkType.type_name'
        db.delete_column('MainApp_drinktype', 'type_name')

        # Adding field 'DrinkType.name'
        db.add_column('MainApp_drinktype', 'name',
                      self.gf('django.db.models.fields.CharField')(default='defaut', max_length=255),
                      keep_default=False)

        # Adding field 'DrinkType.icon'
        db.add_column('MainApp_drinktype', 'icon',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DrinkType.type_name'
        raise RuntimeError("Cannot reverse this migration. 'DrinkType.type_name' and its values cannot be restored.")
        # Deleting field 'DrinkType.name'
        db.delete_column('MainApp_drinktype', 'name')

        # Deleting field 'DrinkType.icon'
        db.delete_column('MainApp_drinktype', 'icon')
